...
public class GetLichChieuRapBUS extends AsyncTask<String,Void,String> {
    ...
    protected String doInBackground(String... params) {
        ...
        URI website = null;
        try {
            //lấy thông tin lịch chiếu của từng rạp. với params là mã rạp
    ...
    protected void onPostExecute(String s) {
        ...
        try {
            //chuyển string sang mảng các json.
            jsonArray = new JSONArray(s);
            JSONObject json_data = null;
            //add thông tin tất cả các phim sắp chiểu của rạp vào listtenphim.
        ...
        //lấy ra danh sách tên các phim từ listtenphim
        ArrayList<String> unique = removeDuplicates(listtenphim);
        final String[] item = new String[unique.size()];
        //thêm danh sách tên phim vừa lấy vào mảng item.
        for(int i =0 ;i < unique.size(); i++) {
            item[i] = unique.get(i);
        }
        //chuyền mảng item và listtenphim vào control expandlistview
