...
public class MyAdapterGridView extends ArrayAdapter<DatGheDTO> {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final int[] maphim = {0};
        final int flag;
        //nếu mã ghế đã được đặt mua thì lấy hình ảnh ghế màu đỏ.
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dv.setTrangthai("1");
                //nếu vé chưa đặt thì cho phép đặt vé.
                if (flag == 0) {
                    ...
                    call.enqueue(new Callback<DatGheDTO>() {
                        ...
                        public void onResponse(Response<DatGheDTO> response, Retrofit retrofit) {
                            //sau khi đặt vé thành công thì đổi màu ghế sang màu xanh lá.
